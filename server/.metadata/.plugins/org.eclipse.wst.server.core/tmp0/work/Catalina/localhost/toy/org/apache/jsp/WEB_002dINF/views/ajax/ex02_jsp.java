 ...
 * Generated at: 2022-07-05 05:30:44 UTC
...
public final class ex02_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("		<section>\r\n");
      out.write("			<h2>기존방식</h2>\r\n");
      out.write("			\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=\"text\" id=\"text1\" value=\"");
      ...
      out.write("\" readonly>\r\n");
      out.write("				<input type=\"button\" value=\"확인\" id=\"btn1\" onclick=\"location.href='/toy/ajax/ex02data.do';\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=\"text\">\r\n");
      out.write("			</div>\r\n");
      out.write("			\r\n");
      out.write("			<h2>Ajax 방식</h2>\r\n");
      out.write("			<!--  -->\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=\"text\" id=\"txt2\" readonly>\r\n");
      out.write("				<input type=\"button\" value=\"확인\" id=\"btn2\" onclick=\"test();\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=\"text\">\r\n");
      out.write("			</div>\r\n");
      out.write("			\r\n");
      out.write("			<h3>Ajax 방식</h3>\r\n");
      out.write("			<input type=\"button\" value=\"확인\" id=\"btn3\" onclick=\"test2();\">\r\n");
      out.write("			<span id=\"txt3\"></span>\r\n");
      out.write("			\r\n");
      out.write("		</section>\r\n");
      out.write("	</main>\r\n");
      out.write("		\r\n");
      ...
      out.write("		\r\n");
      out.write("			//Ajax 통신을 지원하는 자바스크립트 객체\r\n");
      out.write("			ajax = new XMLHttpRequest();\r\n");
      out.write("			\r\n");
      out.write("			//alert(ajax);\r\n");
      out.write("			if (ajax != null) {\r\n");
      out.write("				\r\n");
      out.write("				//서버에게 데이터 요청\r\n");
      out.write("				ajax.onreadystatechange = m1;\r\n");
      out.write("				ajax.open('GET', '/toy/ajax/ex02data2.do');\r\n");
      out.write("				ajax.send(); //<input type=\"submit\">\r\n");
      out.write("				\r\n");
      out.write("			} else {\r\n");
      out.write("				alert('접속한 브라우저가 XMLHttpRequest를 지원하지 않습니다.');\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("				//서버에게 요청한 뒤 돌려받은 데이터\r\n");
      out.write("				//alert(ajax.responseText);\r\n");
      out.write("				$('#txt2').val(ajax.responseText);\r\n");
      out.write("			} \r\n");
      out.write("			\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("			\r\n");
      out.write("			//ajax.open('GET', '/toy/data.txt');\r\n");
      out.write("			//ajax.open('GET', '/toy/data.xml');\r\n");
      out.write("			//ajax.open('GET', '/toy/data.json');\r\n");
      out.write("			//ajax.open('GET', '/toy/data.do');\r\n");
      out.write("			\r\n");
      out.write("			ajax.open('GET', '/toy/data.txt');\r\n");
      out.write("			\r\n");
      out.write("			ajax.send();\r\n");
      ...
      out.write("			\r\n");
      out.write("			console.log('ajax.readyState', ajax.readyState);\r\n");
      out.write("			console.log('ajax.status', ajax.status);\r\n");
      out.write("			\r\n");
      out.write("			//데이터를 받아오는 시점 && 200(성공) 상태인지 확인후\r\n");
      out.write("			if (ajax.readyState == 4 && ajax.status == 200) {\r\n");
      out.write("				console.log(ajax.responseText);\r\n");
      out.write("				\r\n");
      out.write("				//ajax.responseText > 단일 데이터를 가져올 때 사용\r\n");
      out.write("				//ajax.responseXML > 다중 데이터를 가져올 때 사용\r\n");
      out.write("				\r\n");
      out.write("				$('#txt3').text(ajax.responseText);\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			console.log('');\r\n");
      out.write("			//http state code\r\n");
      out.write("			\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("	</script>\r\n");
