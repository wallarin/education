 ...
 * Generated at: 2022-07-05 08:44:31 UTC
...
public final class ex04_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			\r\n");
      out.write("			<h4>비동기 통신</h4>\r\n");
      out.write("			<input type=\"button\" value=\"확인\" class=\"btn btn-primary\" id=\"btn1\">\r\n");
      out.write("			<span id=\"msg1\"></span>\r\n");
      out.write("			\r\n");
      out.write("			<h4>동기 통신</h4>\r\n");
      out.write("			<input type=\"button\" value=\"확인\" class=\"btn btn-primary\" id=\"btn2\">\r\n");
      ...
      out.write("			<hr>\r\n");
      out.write("			\r\n");
      out.write("			<h4>통신 패턴 3가지</h4>\r\n");
      out.write("			<input type=\"button\" value=\"1. 서버로부터 데이터 가져오기\" class=\"btn btn-primary\" id=\"btn3\">\r\n");
      out.write("			<input type=\"button\" value=\"2. 서버에게 데이터 보내기\" class=\"btn btn-primary\" id=\"btn4\">\r\n");
      out.write("			<input type=\"button\" value=\"3. 서버에게 데이터 보내기 + 서버로부터 데이터 가져오기\" class=\"btn btn-primary\" id=\"btn5\">\r\n");
      out.write("			\r\n");
      out.write("			<hr>\r\n");
      out.write("			\r\n");
      out.write("			<h4>jQuery Ajax</h4>\r\n");
      out.write("			<div id=\"msg3\">결과: <span></span></div>\r\n");
      out.write("			<input type=\"button\" value=\"데이터 가져오기\" class=\"btn btn-primary\" id=\"btn6\">\r\n");
      out.write("			\r\n");
      out.write("		</section>\r\n");
      out.write("	</main>\r\n");
      out.write("		\r\n");
      ...
      out.write("			ajax.open('GET', '/toy/ajax/ex04data.do', true); //비동기 통신을 해라\r\n");
      out.write("			ajax.send();\r\n");
      out.write("			\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      ...
      out.write("				$('#msg1').text(ajax.responseText);\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("			\r\n");
      out.write("			ajax = new XMLHttpRequest();\r\n");
      out.write("			ajax.onreadystatechange = m2;\r\n");
      out.write("			ajax.open('GET', '/toy/ajax/ex04data.do', false); //동기 통신을 해라\r\n");
      out.write("			ajax.send();\r\n");
      out.write("			\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      ...
      out.write("			if (ajax.readyState == 4 && ajax.status == 200) {\r\n");
      out.write("				$('#msg2').text(ajax.responseText);\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
      ...
      out.write("			//데이터 가져오기\r\n");
      out.write("			ajax = new XMLHttpRequest();\r\n");
      out.write("			ajax.open('GET', '/toy/ajax/ex04data3.do');\r\n");
      out.write("			ajax.onreadystatechange = function() { //데이터 수신을 위해서(***)\r\n");
      out.write("				if (ajax.readyState == 4 && ajax.status == 200) {\r\n");
      ...
      out.write("	         //데이터 보내기(GET, POST)\r\n");
      out.write("	         ajax = new XMLHttpRequest();\r\n");
      out.write("	         ajax.open('POST', '/toy/ajax/ex04data4.do?name1=aaa'); //데이터 전송(GET)\r\n");
      out.write("	         ajax.setRequestHeader(\"Content-type\", \"application/x-www-form-urlencoded\"); \r\n");
      out.write("	         ajax.send('name2=bbb'); //데이터 전송(POST)\r\n");
      out.write("	      });\r\n");
      out.write("		\r\n");
      out.write("		$('#btn5').click(function() {\r\n");
      out.write("			ajax = new XMLHttpRequest();\r\n");
      out.write("			ajax.open('GET', '/toy/ajax/ex04data5.do?name=hong');\r\n");
      out.write("			ajax.onreadystatechange = function() { //데이터 수신을 위해서(***)\r\n");
      out.write("				if (ajax.readyState == 4 && ajax.status == 200) {\r\n");
      out.write("					alert(ajax.responseText);\r\n");
      out.write("				}\r\n");
      ...
      out.write("			$.ajax({\r\n");
      out.write("				type: 'GET', // == ajax.open('GET') - 요청 메소드 방식\r\n");
      out.write("				url: '/toy/ajax/ex04data3.do', // == ajax.open('GET', 'URL') - 요청 서버 주소\r\n");
      out.write("				\r\n");
      ...
      out.write("			$.ajax({\r\n");
      out.write("				type: 'GET',\r\n");
      out.write("				url: '/toy/ajax/ex04data4.do',\r\n");
      out.write("				data: 'name1=hong&name2=lee', //QueryString > key = value\r\n");
      out.write("				error: function(a,b,c) {\r\n");
      out.write("					console.log(a,b,c);\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
