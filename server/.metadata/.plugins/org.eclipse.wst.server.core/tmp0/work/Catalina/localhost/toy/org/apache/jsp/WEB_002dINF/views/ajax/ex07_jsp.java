 ...
 * Generated at: 2022-07-06 15:20:00 UTC
...
public final class ex07_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	.table td:nth-child(5) { text-align: left; }\r\n");
      out.write("	.table th:nth-child(1) { width: 120px; }\r\n");
      out.write("	.table th:nth-child(2) { width: 80px; }\r\n");
      out.write("	.table th:nth-child(3) { width: 80px; }\r\n");
      out.write("	.table th:nth-child(4) { width: 160px; }\r\n");
      out.write("	.table th:nth-child(5) { width: auto; }\r\n");
      out.write("	.table th:nth-child(6) { width: 80px; }\r\n");
      out.write("	\r\n");
      out.write("	form input, form select { margin: 10px 0; }\r\n");
      out.write("	form input[type=text] { width: 120px; }\r\n");
      out.write("	form input[type=text]:nth-child(4) { width: 200px; }\r\n");
      out.write("	form input[type=text]:nth-child(5) { width: 400px; }\r\n");
      out.write("	form select.form-control { width: 120px; }\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("			<h2>주소록\r\n");
      out.write("				<small>\r\n");
      out.write("					<input type=\"button\" value=\"남자\" class=\"btn btn-primary\" onclick=\"search('m');\">\r\n");
      out.write("					<input type=\"button\" value=\"여자\" class=\"btn btn-danger\" onclick=\"search('f');\">\r\n");
      out.write("					<input type=\"button\" value=\"모두\" class=\"btn btn-info\" onclick=\"search('all');\">\r\n");
      out.write("				</small>\r\n");
      out.write("			</h2>\r\n");
      out.write("			\r\n");
      ...
      out.write("				<div>\r\n");
      out.write("					<input type=\"text\" name=\"name\" id=\"name\" class=\"form-control\" placeholder=\"이름\">\r\n");
      out.write("					<input type=\"text\" name=\"age\" id=\"age\" class=\"form-control\" placeholder=\"나이\">\r\n");
      ...
      out.write("					</select>\r\n");
      out.write("					<input type=\"text\" name=\"tel\" id=\"tel\" class=\"form-control\" placeholder=\"전화\">\r\n");
      out.write("					<input type=\"text\" name=\"address\" id=\"address\" class=\"form-control\" placeholder=\"주소\">\r\n");
      out.write("				</div>\r\n");
      out.write("				<div class=\"btns\">\r\n");
      out.write("					<input type=\"button\" value=\"등록하기\" class=\"btn btn-primary\" onclick=\"add();\">\r\n");
      out.write("				</div>\r\n");
      out.write("			</form>\r\n");
      out.write("			\r\n");
      out.write("		</section>\r\n");
      ...
      out.write("			$.ajax ({\r\n");
      out.write("				type: 'POST',\r\n");
      out.write("				url: '/toy/ajax/ex07add.do',\r\n");
      out.write("				data: $('#form').serialize(),\r\n");
      out.write("				dataType: 'json',\r\n");
      out.write("				success: function(result) {\r\n");
      out.write("					\r\n");
      out.write("					if (result.seq != \"0\") {\r\n");
      out.write("						\r\n");
      out.write("						let temp = '';\r\n");
      out.write("						\r\n");
      out.write("						temp += '<tr>';\r\n");
      out.write("						\r\n");
      out.write("						temp += '<td>' + $('#name').val() + '</td>';\r\n");
      out.write("						temp += '<td>' + $('#age').val() + '</td>';\r\n");
      out.write("						temp += '<td>' + $('#gender').val() + '</td>';\r\n");
      out.write("						temp += '<td>' + $('#tel').val() + '</td>';\r\n");
      out.write("						temp += '<td>' + $('#address').val() + '</td>';\r\n");
      out.write("						temp += '<td><input type=\"button\" value=\"삭제\" class=\"btn btn-warning\" onclick=\"del(' + result.seq + ');\"></td>';\r\n");
      out.write("						\r\n");
      out.write("						temp += '</tr>';\r\n");
      out.write("						\r\n");
      ...
      out.write("			$.ajax ({\r\n");
      out.write("				type: 'GET',\r\n");
      out.write("				url: '/toy/ajax/ex07del.do',\r\n");
      ...
      out.write("		\r\n");
      out.write("		\r\n");
      out.write("		function search(gender) {\r\n");
      out.write("			\r\n");
      out.write("			$.ajax ({\r\n");
      out.write("				type: 'GET',\r\n");
      out.write("				url: '/toy/ajax/ex07search.do',\r\n");
      out.write("				data: 'gender=' + gender,\r\n");
      out.write("				dataType: 'json',\r\n");
      out.write("				success: function(result) {\r\n");
      out.write("					\r\n");
      out.write("					$('table tbody').html('');\r\n");
      out.write("					\r\n");
      ...
      out.write("							temp += '<td>' + item.age + '</td>';\r\n");
      out.write("							temp += '<td>' + item.gender + '</td>';\r\n");
      out.write("							temp += '<td>' + item.tel + '</td>';\r\n");
      out.write("							temp += '<td>' + item.address + '</td>';\r\n");
      out.write("							temp += '<td><input type=\"button\" value=\"삭제\" class=\"btn btn-warning\" onclick=\"del(' + item.seq + ');\"></td>';\r\n");
      out.write("							\r\n");
      out.write("							temp += '</tr>';\r\n");
      out.write("							\r\n");
      out.write("							$('table tbody').append(temp);\r\n");
      ...
      out.write("						\r\n");
      out.write("					} else {\r\n");
      out.write("						$('table tbody').append('<tr><td colspan=\"6\">출력할 데이터가 존재하지 않습니다.</td></tr>');\r\n");
      out.write("					}\r\n");
      out.write("					\r\n");
      out.write("				},\r\n");
      out.write("				error: function(a,b,c) {\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/ajax/ex07.jsp(52,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/ajax/ex07.jsp(52,6) '${alist}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${alist}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/ajax/ex07.jsp(52,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("</td>\r\n");
            out.write("						<td><input type=\"button\" value=\"삭제\" class=\"btn btn-warning\" onclick=\"del(");
